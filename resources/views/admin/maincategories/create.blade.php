                            ...
                            <form class="form" action="{{route('admin.maincategories.store')}}" method="POST"
                                ...
                                <div class="form-body">
                                    ...
                                    @if(get_languages()->count() > 0)
                                      @foreach(get_languages() as $index => $row)
                                      <div class="row">
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <label for="projectinput1"> اسم القسم [ {{$row->name}} ]</label>
                                                  <input type="text"
                                                         class="form-control"
                                          ...
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  <input type="hidden" value="{{$row->abbr}}"
                                                         class="form-control"
                                          ...
                                          <div class="col-md-6">
                                              <div class="form-group mt-1">
                                                  ...
                                                  <label for="switcheryColor4"
                                                         class="card-title ml-1">الحالة [ {{$row->name}} ]</label>
