                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="diraction" class="select2 form-control">
                                                    <optgroup label="من فضلك أختر اتجاه اللغة ">
                                                        <option value="rtl" @if($lang->diraction == 'rtl') selected @endif>من اليمين الي اليسار</option>
                                                        <option value="ltr" @if($lang->diraction == 'ltr') selected @endif>من اليسار الي اليمين</option>
                                                    </optgroup>
                                                </select>
                                                @error('diraction')
                                                  <span class="text-danger">{{$message}} </span>
